              ...
              >
                <span style={{ textAlign: 'left', minWidth: 0 }}>
                  <span className="sx-kicker" style={{ display: 'block' }}>
                    Route · {['Empty','1/8','1/4','3/8','1/2','5/8','3/4','7/8','Full'][currentFuelEighths]} tank
                  </span>
                                      ...
                                      <div style={{ flex: 1, minWidth: 0 }}>
                                        ...
                                        <div style={{ display: 'flex', gap: 14, fontSize: 12, color: 'var(--mute)', marginBottom: 10, flexWrap: 'wrap', alignItems: 'center' }}>
                                          ...
                                          {avoidNight && (() => {
                                            ...
                                            return t ? (
                                              <span className="sx-pill sx-pill-amber" style={{ fontSize: 10 }}>🌙 lands ~{t} (rough)</span>
                                            ) : null
                                          })()}
              ...
              <div className="sx-card-flat" style={{ marginTop: 14 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 8 }}>
                  ...
                  {selectedStation.catScale === true && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                      <span style={{ fontSize: 14 }}>⚖️</span>
                      <span style={{ fontSize: 12, color: 'var(--steel)' }}>{(selectedStation.brand || 'pfj') === 'ta' ? 'Truck Scale' : 'CAT Scale'}</span>
                    </div>
                  )}
                </div>
              </div>
